...
public class BootcampReportDocument {
    ...
    public BootcampReportDocument(String reportId, String bootcampId, String bootcampName, String bootcampDescription,
                                 LocalDate releaseDate, Integer duration, List<CapabilityDocument> capabilities,
                                 List<TechnologyDocument> technologies, List<EnrollmentDocument> enrollments,
    ...
    public List<EnrollmentDocument> getEnrollments() {
        return enrollments;
    }

    public void setEnrollments(List<EnrollmentDocument> enrollments) {
        this.enrollments = enrollments;
    }
